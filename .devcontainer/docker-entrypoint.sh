...
# The script is copied during build to /.devcontainer/
if [ -f "/.devcontainer/init-security.sh" ]; then
    ...
    bash /.devcontainer/init-security.sh
    SECURITY_STATUS=$?
    ...
    echo -e "    Expected at: /.devcontainer/init-security.sh"
