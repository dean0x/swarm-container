...
> **📦 New in v1.1.0**: SwarmContainer is now a drop-in devcontainer! Clone directly into your project's `.devcontainer` folder. See [Integration Options](#integration-options) below.
